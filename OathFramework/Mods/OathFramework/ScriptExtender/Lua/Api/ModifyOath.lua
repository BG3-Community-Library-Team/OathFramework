...
function Api.ModifyOath(payload)
  ...
  if modsLoaded then
    CLUtils.Info("Modifying Oath: " .. payload.EventType .. " Oath " .. Ext.StaticData.Get(payload.SubclassTagId, "Tag").Name .. " for character ID: " .. payload.CharacterId .. ". Request sent from mod " .. table.concat(payload.modGuids, ", "), Globals.InfoOverride)
